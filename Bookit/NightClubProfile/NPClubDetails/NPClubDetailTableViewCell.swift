        ...
        didSet {
            ...
            if let person = UserDefaults.standard.value(forKey: "keyLoginFullData") as? [String:Any] {
                ...
                if (person["role"] as! String) == "Club" {
                    btn_events.setTitle("Event calendar", for: .normal)
                } else {
                    btn_events.setTitle("Events", for: .normal)
                }
            } else {
                btn_events.setTitle("Events", for: .normal)
            }
            
            btn_events.setTitleColor(.black, for: .normal)
            btn_events.layer.shadowColor = UIColor(red: 0, green: 0, blue: 0, alpha: 0.25).cgColor
            btn_events.layer.shadowOffset = CGSize(width: 0.0, height: 2.0)
            btn_events.layer.shadowOpacity = 1.0
            btn_events.layer.shadowRadius = 15.0
            btn_events.layer.masksToBounds = false
            btn_events.layer.cornerRadius = 15
            btn_events.backgroundColor = .white
